...
import com.gst.infrastructure.codes.data.CodeData;
...
public class CodeReadPlatformServiceImpl implements CodeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "codes", key = "T(com.gst.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('CD')")
