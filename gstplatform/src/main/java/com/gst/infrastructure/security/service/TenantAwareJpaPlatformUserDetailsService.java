 ...
 * under the License.
 */
package com.gst.infrastructure.security.service;

import com.gst.infrastructure.security.domain.PlatformUser;
import com.gst.infrastructure.security.domain.PlatformUserRepository;
...
public class TenantAwareJpaPlatformUserDetailsService implements PlatformUserDetailsService {
    ...
    @Override
    @Cacheable(value = "usersByUsername", key = "T(com.gst.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#username+'ubu')")
