 ...
 * under the License.
 */
package com.gst.infrastructure.security.filter;
...
import com.gst.infrastructure.security.data.PlatformRequestLog;
import com.gst.infrastructure.security.exception.InvalidTenantIdentiferException;
import com.gst.infrastructure.security.service.BasicAuthTenantDetailsService;
...
public class TenantAwareTenantIdentifierFilter extends GenericFilterBean {
    ...
    private final String tenantRequestHeader = "GSTPlatform-TenantId";
