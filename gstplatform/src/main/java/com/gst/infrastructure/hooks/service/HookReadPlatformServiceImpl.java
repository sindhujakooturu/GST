...
import com.gst.infrastructure.hooks.data.*;
...
public class HookReadPlatformServiceImpl implements HookReadPlatformService {
    ...
    @Override
    @Cacheable(value = "hooks", key = "T(com.gst.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('HK')")
