 ...
 * under the License.
 */
package com.gst.infrastructure.campaigns.helper;
...
import com.gst.infrastructure.campaigns.sms.data.MessageGatewayConfigurationData;
import com.gst.infrastructure.configuration.service.ExternalServicesPropertiesReadPlatformService;
...
public class SmsConfigUtils {
    ...
    public Map<String, Object> getMessageGateWayRequestURI(final String apiEndPoint, String apiQueueResourceDatas) {
        ...
        headers.add(SmsCampaignConstants.GST_PLATFORM_TENANT_ID, tenant.getTenantIdentifier());
