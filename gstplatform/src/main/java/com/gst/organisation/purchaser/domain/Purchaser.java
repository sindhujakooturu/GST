...
public class Purchaser extends AbstractPersistableCustom<Long> {
	...
	@Column(name="purchaser_name", length = 256)
	...
	public Purchaser(){
	 ...
	 public static Purchaser fromJson(final JsonCommand command) {
	        ...
	        final String purchaserParamName = "purchaserName";
	        final String purchaserName = command.stringValueOfParameterNamedAllowingNull(purchaserParamName);
	        ...
	        return new Purchaser(gstin, gstinComp, purchaserName, contactName, officePhone, homePhone, rmn
	        		,fax,rmail,panNo,etin,addrLine1,addrLine2,city,state,country,pin);
	    }
	
	public Purchaser(final String gstin,final String gstinComp,final String purchaserName,
	...
	public Map<String, Object> update(final JsonCommand command) {
		        ...
		        final String purchaserParamName = "purchaserName";
		        if (command.isChangeInStringParameterNamed(purchaserParamName, this.purchaserName)) {
		            final String newValue = command.stringValueOfParameterNamed(purchaserParamName);
		            actualChanges.put(purchaserParamName, newValue);
		            this.purchaserName = StringUtils.defaultIfEmpty(newValue, null);
		        }
		        final String contactParamName = "contactName";
