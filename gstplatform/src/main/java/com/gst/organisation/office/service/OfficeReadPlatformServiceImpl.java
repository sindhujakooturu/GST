 ...
 * under the License.
 */
package com.gst.organisation.office.service;
...
import com.gst.organisation.office.data.OfficeTransactionData;
import com.gst.organisation.office.exception.OfficeNotFoundException;
...
public class OfficeReadPlatformServiceImpl implements OfficeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "offices", key = "T(com.gst.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')")
    ...
    @Override
    @Cacheable(value = "officesForDropdown", key = "T(com.gst.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'ofd')")
    ...
    @Override
    @Cacheable(value = "officesById", key = "T(com.gst.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#officeId)")
