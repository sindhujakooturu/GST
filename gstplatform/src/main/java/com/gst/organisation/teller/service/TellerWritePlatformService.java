 ...
 *
 * @author Markus Geiss
 * @see com.gst.organisation.teller.domain.TellerRepository
 * @since 2.0.0
 */
public interface TellerWritePlatformService {
     ...
     * @throws com.gst.infrastructure.core.exception.PlatformApiDataValidationException
     * @throws com.gst.infrastructure.core.exception.InvalidJsonException
     */
     ...
     * @return {@code CommandProcessingResult} if successful
     * @throws com.gst.organisation.teller.exception.TellerNotFoundException
     * @throws com.gst.infrastructure.core.exception.PlatformApiDataValidationException
     * @throws com.gst.infrastructure.core.exception.InvalidJsonException
     */
