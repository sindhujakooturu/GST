 ...
 * under the License.
 */
package com.gst.organisation.teller.domain;
...
public class Cashier extends AbstractPersistableCustom<Long> {
     ...
     * @see com.gst.organisation.office.domain.Office
     */
     ...
     * @see com.gst.organisation.staff.domain.Staff
     */
     ...
     * @see com.gst.organisation.teller.domain.Teller
     */
