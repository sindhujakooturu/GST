...
@Entity
@Table(name = "g_sac_data", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "sac_seq_id" }, name = "sacSeqId_UNIQUE"),
...
public class Sacdata extends AbstractPersistableCustom<Long> {
	...
	private Sacdata(final String sacSeqId, final String serviceName,
		final String description, final String sacTaxCollection,
		final String sacOtherReciept, final String sacDeductRefund,
		final String sacPenalty) {
	...
	public void delete() {
    	...
    	this.sacSeqId=this.getId()+"_"+this.sacSeqId;
    	this.serviceName=this.getServiceName()+""+this.serviceName;
    	this.deleted="true";
     }
