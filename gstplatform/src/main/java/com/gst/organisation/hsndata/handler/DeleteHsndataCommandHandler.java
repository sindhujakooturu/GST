...
public class DeleteHsndataCommandHandler implements NewCommandSourceHandler {
	
	
	 private final HsndataWritePlatformService writePlatformService;

	    @Autowired
	    public DeleteHsndataCommandHandler(final HsndataWritePlatformService writePlatformService) {
