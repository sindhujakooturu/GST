...
import com.gst.infrastructure.accountnumberformat.service.AccountNumberFormatConstants;
import com.gst.portfolio.client.api.ClientApiConstants;
import com.gst.portfolio.paymenttype.api.PaymentTypeApiResourceConstants;
...
public class CommandWrapperBuilder {
   ...
   public CommandWrapperBuilder deleteHsndata(final Long id) {
    ...
    public CommandWrapperBuilder updateB2BInvoiceStatus(final Long id) {
        this.actionName = "UPDATE";
        this.entityName = "B2BINVOICESTATUS";
        this.entityId = id;
        this.href = "/b2binvoice/"+id+"?updateStatus=true";
        return this;
    }
    public CommandWrapperBuilder updateB2BInvoice(final Long id) {
        this.actionName = "UPDATE";
        this.entityName = "B2BINVOICE";
        this.entityId = id;
