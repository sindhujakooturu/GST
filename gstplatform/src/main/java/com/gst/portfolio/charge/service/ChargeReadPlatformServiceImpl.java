 ...
 * under the License.
 */
package com.gst.portfolio.charge.service;
...
import com.gst.portfolio.charge.domain.ChargeAppliesTo;
import com.gst.portfolio.charge.domain.ChargeTimeType;
import com.gst.portfolio.charge.exception.ChargeNotFoundException;
...
public class ChargeReadPlatformServiceImpl implements ChargeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "charges", key = "T(com.gst.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('ch')")
